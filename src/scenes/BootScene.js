...
var BootScene = new Phaser.Class({
  ...
  preload: function ()
  {
    ...
    // map tiles
    this.load.image('reduced', 'assets/maps/reduced.png');

    // map(s) in json format
    this.load.tilemapTiledJSON('utfmap', 'assets/maps/utfmap.json');
    this.load.tilemapTiledJSON('blocoA', 'assets/maps/blocoA.json');
    this.load.tilemapTiledJSON('blocoB', 'assets/maps/blocoA.json');
    this.load.tilemapTiledJSON('blocoC', 'assets/maps/blocoA.json');
    this.load.tilemapTiledJSON('blocoD', 'assets/maps/blocoA.json');
